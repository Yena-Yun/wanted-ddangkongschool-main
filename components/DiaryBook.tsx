...
const DiaryBook = () => {
  ...
  return (
    <Contaniner>
      <InnerContainner>
        <Header>
          <Title data-aos="fade-up">매일 매일 <br />
          알아서 기록하는 독서 일기</Title>
          <TabTitle data-aos="fade-up">매일 매일 알아서 <br />
          기록하는 독서 일기</TabTitle>
          <SubTitle data-aos="fade-up">오늘은 아이가 어떤 책을 읽었는지, 어떤 활동에 참여했는지 독서일기를 통해 확인해보세요. <br />
          읽기만 해도 자동으로 기록되고, 공유도 가능해요.</SubTitle>
          <TabSubTitle data-aos="fade-up">오늘은 아이가 어떤 책을 읽었는지, 어떤 활동에 참여했는지 <br />
          독서일기를 통해 확인해보세요. <br />
          읽기만 해도 자동으로 기록되고, 공유도 가능해요.</TabSubTitle>
          <MobileSubTitle data-aos="fade-up">오늘은 아이가 어떤 책을 읽었는지, <br />
          어떤 활동에 참여했는지 <br />
          독서일기를 통해 확인해보세요. <br />
          읽기만 해도 자동으로 기록되고, <br />
